  ...
  return (
        ...
        cardContent={<div>
          <h3 align="left">Haptic paddle project</h3>
           <p align="left">
           We handled a project with an "haptic paddle", a complete mechanical device with full laptop control interface. <br/>
           The implementation was made in C and the figures and interpretation in matlab. <br/><br/>
          ...
          Haptic is define by real and simulated touch interactions. The haptic human robot interfaces epfl course aims to teach the basics of
           haptic devices, force feedback and mechanical man-machine interfaces. <br/></p>
