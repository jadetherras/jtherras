...
const Haptic = () => {
  ...
  return (
        ...
        cardContent={<div>
          ...
          <p align="left">
          Haptics is define by real and simulated touch interactions. The haptic human robot intefaces epfl course aims to teach the basics of
           ...
           both position control and force control. We finally had to find a way to handle muscle tremors, obtaining a stable control. 
                ...
                <div>
                <button class="button-48" role="button" onClick={() =>window.open(report1)}><span class="text"><FaFileAlt />See report - SIMULATION AND REALISATION OF A PID CONTROLLER </span></button><br/>  
