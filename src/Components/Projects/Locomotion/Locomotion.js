...
without EES<SUP ID="EES"/> stimulation in comparison to healthy subjects </div>}
        ...
        cardContent={<div>
          ...
          <br/><br/>
          The course cover multiple locomotion analysis tools and propose hand-on project to fully understand each of them. We had been introduced to the SLIP (Spring-Loaded Inverted Pendulum) model, a simple gait model.
          Then worked with OpenSim on a musculoskeletal model. Finally, we discovered SCONE, an open-source software for predictive simulation of human and animal motion. <br/><br/>
          A second part of the course consisted on gait analysis project in matlab.
           <br/></p>
           <h3 align="left">The gate analysis project</h3>
           <p align="left">
            ...
            Participants with SCI were supported by an overground robot, and had to walk first without stimulation, and secondly with stimulation in similar conditions as healthy subject. <br/><br/>
            First, we developed an algorithm to extract gait event from the data,  and visualized the walking pattern for all subjects. Secondly, we choose and extracted relevant gait and EMG parameters
            to assess the subject walking performance. Finally, we performed a PCA<SUP ID="PCA"/> analysis, and concluding that EES stimulation effectively improved the gait of SCI patient. Notably, 
            ...
            <br/><br/>
            (of course, patient datasets are not available on the git repository, only the code is available)
           </p>
                <div>
