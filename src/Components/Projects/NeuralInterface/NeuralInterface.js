...
const NeuralInterface = () => {
  ...
  return (
        ...
        cardContent={<div>
            ...
            <p align="left">
              The neural interface master course of EPFL propose a project : Look into 
              neural interface state of the art product and propose a way to improve the product. <br/>
              During the edition 2022 of Hackathealth, an assistive technology hackathon hosted at EPFL, a project involved a child with incomplete tetraplegia and proprioception limitation resulting 
            ...
            <h3 align="left">Product proposition and development</h3>
            <p align="left">
              We suggested and developed a wireless active flexible microneedle-array-electrode system, suitable for long-term recording
          ...
          <p align="left">
            We had the opportunity to continue working on the project in collaboration with the patient therapists. We then worked mainly on data analysis of the past
